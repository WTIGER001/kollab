...
Kollab supports multiple visual aesthetics to fit your personal or team's workflow style. Rather than just switching between Light and Dark modes, you can change the entire "Theme" of the application—altering fonts, border radius, component styling, and background textures.
...
## How to Evaluate and Switch Themes

> [!NOTE]  
> The Theme Selector is currently available as a quick-access tool in the bottom right corner of your workspace.

To switch your theme:
1. Look for the floating **Palette Button** in the bottom right corner of the Kollab interface.
