...
You can open the search panel at any time using either of these methods:
1.  **Sidebar Trigger**: Click on the search bar labeled *"Search document..."* at the top of the sidebar.
2.  **Keyboard Shortcut**: Press **`⌘P`** (Mac) or **`Ctrl+P`** (Windows/Linux) globally on your keyboard.

---

## ⌨️ How to Use the Search Panel

Once the search panel is open:
1.  **Type your query**: Type what you are looking for. You can write:
...
2.  **Navigate with Keyboard**:
    *   Use the **Up/Down arrow keys (`↑` / `↓`)** to select a search result in the list.
    *   Press **`Enter`** to open the selected document.
3.  **Close Search**: Click the **`X`** button, click outside the panel, or press **`ESC`** on your keyboard.
