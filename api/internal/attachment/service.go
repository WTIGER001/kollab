...
func (s *AttachmentService) GetAsposeConfig(ctx context.Context) (*domain.AsposeConfig, error) {
	return s.asposeClient.GetConfig(ctx)
}

func (s *AttachmentService) UpdateAsposeConfig(ctx context.Context, enabled bool, licenseXml string) (*domain.AsposeConfig, error) {
	return s.asposeClient.UpdateConfig(ctx, enabled, licenseXml)
}
