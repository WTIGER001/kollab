  ...
  return (
    <Box>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5, mb: 2 }}>
        {/* Auto saves */}
        <Box sx={{ border: "1px solid var(--border-color)", borderRadius: "var(--border-radius-card)", p: 2 }}>
        ...
        <Box sx={{ border: "1px solid var(--border-color)", borderRadius: "var(--border-radius-card)", p: 2 }}>
          <Typography variant="subtitle2" sx={{ fontWeight: 600, display: "flex", alignItems: "center", gap: 1, mb: 0.5 }}>
            <Info size={15} style={{ color: "var(--accent-color)" }} />
        ...
        <Box sx={{ border: "var(--border-width) solid var(--border-color)", borderRadius: "var(--border-radius-card)", p: 2, color: "var(--text-primary)" }}>
          <Typography variant="subtitle2" sx={{ fontWeight: 600, mb: 0.5 }}>Restoring a version</Typography>
          <Typography variant="body2" sx={{ color: "var(--text-secondary)" }}>Save current work before restoring. Kollab creates a recovery checkpoint, restores the selected content, and reloads connected editors across API replicas so old collaborative state cannot overwrite the restored page.</Typography>
        </Box>
      </Box>
    </Box>
  );
