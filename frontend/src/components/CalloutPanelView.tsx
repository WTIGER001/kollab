...
import { Info, AlertCircle, Lightbulb, AlertTriangle, Trash2 } from "lucide-react";

export const CalloutPanelView: React.FC<NodeViewProps> = ({ node, deleteNode, updateAttributes }) => {
        ...
        >
          ...
          <Tooltip title="Warning" arrow>
            <IconButton
              ...
              sx={{
                p: 0.5,
                color: type === "warning" ? "#ef4444" : "text.disabled",
                backgroundColor: type === "warning" ? "rgba(239, 68, 68, 0.08)" : "transparent",
